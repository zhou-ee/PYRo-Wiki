...
File<Badge type = "info" text="pyro_core_dma_heap.h"/><Badge type = "info" text="pyro_core_dma_heap.cpp"/><Badge type = "info" text="pyro_core_mem.cpp"/>
# PYRo Memory
...
<AuthorCard author="Lucky" />Version<Badge type ="tip" text="1.0.0"/>  
File<Badge type = "info" text="pyro_core_dma_heap.h"/><Badge type = "info" text="pyro_core_dma_heap.cpp"/><Badge type = "info" text="pyro_core_mem.cpp"/>
# PYRo Memory
...
在 STM32H7 架构中，默认的系统堆（System Heap）通常被Version<Badge type ="tip" text="1.0.0"/>  
File<Badge type = "info" text="pyro_core_dma_heap.h"/><Badge type = "info" text="pyro_core_dma_heap.cpp"/><Badge type = "info" text="pyro_core_mem.cpp"/>
# PYRo Memory
...
<AuthorCard author="Lucky" />配置在 DTCMRAM 中。然而，DTCM 仅通过专用总线与 CPU 直接相连，DMA无法访问 DTCMRAM 区域。
